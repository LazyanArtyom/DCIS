...
class GraphProcessor
{
  public:
    ...
    static void sendFileToDrone(QString serverIP, int port, QFile file)
    {
        ...
        // "C:\\Users\\Atash\\Desktop\\build-DCIS-Desktop_Qt_6_5_0_MSVC2019_64bit-Debug\\CMakeCache.txt"; QString
        // localFilePath = "/c/Users/Atash/Desktop/build-DCIS-Desktop_Qt_6_5_0_MSVC2019_64bit-Debug/CMakeCache.txt";
        ...
        scpArguments /*<< "-P" << QString::number(port)*/ << "-i" << privateKeyPath << localFilePath
    ...
    if (!file.open(QIODevice::ReadOnly)) {
        ...
        dcis::common::utils::DebugStream::getInstance().log(dcis::common::utils::LogLevel::Info, "ERROR: File not
    found"); return;
    }
    ...
    if (socket.waitForConnected()) {
        ...
        file.close();
        dcis::common::utils::DebugStream::getInstance().log(dcis::common::utils::LogLevel::Info, "File sent
    successfully"); } else {
        // Handle connection error
        dcis::common::utils::DebugStream::getInstance().log(dcis::common::utils::LogLevel::Info, "ERROR: Failed to
    connect to the drone");
        ...
        // QStringList scpArgs;
        // scpArgs << "-P" << QString::number(port) << localFilePath << username + "@" + ipAddress + ":" +
        // remoteFilePath;
